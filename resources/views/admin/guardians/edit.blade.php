...
<div class="p-6">
    ...
    {{-- Form --}}
    <form
        action="{{ route('guardians.update', $guardian) }}"
        method="POST"
    >
            ...
            <div class="grid grid-cols-1 gap-6 p-8 md:grid-cols-2">
                ...
                <div>
                    ...
                    >
                        ...
                        <option
                            value="ayah"
                            {{ old('relationship', $guardian->relationship) === 'ayah' ? 'selected' : '' }}
                        >
                            Ayah
                        </option>
                        ...
                        <option
                            value="ibu"
                            {{ old('relationship', $guardian->relationship) === 'ibu' ? 'selected' : '' }}
                        >
                            Ibu
                        </option>
                        ...
                        <option
                            value="wali"
                            {{ old('relationship', $guardian->relationship) === 'wali' ? 'selected' : '' }}
                        >
                            Wali
                        </option>
