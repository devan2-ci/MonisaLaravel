...
<div class="p-6">
    ...
    <div class="mb-6">
        ...
        <p class="mt-1 text-gray-500">
            Buat rombongan belajar baru untuk sekolah.
        </p>
            ...
            <div class="grid grid-cols-1 gap-6 p-8 md:grid-cols-2">
                ...
                <div>
                    ...
                    >
                        ...
                        <option value="10" {{ old('jenjang') == '10' ? 'selected' : '' }}>
                            Kelas 10
                        </option>

                        <option value="11" {{ old('jenjang') == '11' ? 'selected' : '' }}>
                            Kelas 11
                        </option>

                        <option value="12" {{ old('jenjang') == '12' ? 'selected' : '' }}>
                            Kelas 12
                        </option>
                    ...
                    >
                        ...
                        @foreach($schoolMajors as $schoolMajor)
                            ...
                            <option
                                ...
                                {{ old('school_major_id') == $schoolMajor->id ? 'selected' : '' }}
                            >
                ...
                <div>
                    ...
                    <p class="mt-1 text-xs text-gray-400">
                        Bisa menggunakan angka maupun huruf.
                    </p>
