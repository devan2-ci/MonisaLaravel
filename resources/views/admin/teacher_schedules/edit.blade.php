...
<div class="p-6">
    ...
    {{-- Form --}}
    <form
        action="{{ route('teacher-schedules.update', $teacherSchedule) }}"
        method="POST"
    >
            ...
            <div class="grid grid-cols-1 gap-6 p-8 md:grid-cols-2">
                ...
                <div>
                    ...
                    >
                        ...
                        @foreach($teachers as $teacher)
                            ...
                            <option
                                value="{{ $teacher->id }}"
                                {{ old('teacher_id', $teacherSchedule->teacher_id) == $teacher->id ? 'selected' : '' }}
                            >
                ...
                <div>
                    ...
                    >
                        ...
                        @foreach($rombels as $rombel)
                            ...
                            <option
                                value="{{ $rombel->id }}"
                                {{ old('rombel_id', $teacherSchedule->rombel_id) == $rombel->id ? 'selected' : '' }}
                            >
                ...
                <div>
                    ...
                    >
                        ...
                        @foreach($hari as $item)
                            ...
                            <option
                                value="{{ $item }}"
                                {{ old('hari', $teacherSchedule->hari) == $item ? 'selected' : '' }}
                            >
                                {{ ucfirst($item) }}
                            </option>
                ...
                <div>
                    ...
                    >
                        ...
                        @foreach($lessonPeriods as $period)
                            ...
                            <option
                                value="{{ $period->id }}"
                                {{ old('lesson_period_start_id', $teacherSchedule->lesson_period_start_id) == $period->id ? 'selected' : '' }}
                            >
                                Jam {{ $period->jam_ke }}
                ...
                <div>
                    ...
                    >
                        ...
                        @foreach($lessonPeriods as $period)
                            ...
                            <option
                                value="{{ $period->id }}"
                                {{ old('lesson_period_end_id', $teacherSchedule->lesson_period_end_id) == $period->id ? 'selected' : '' }}
                            >
                                Jam {{ $period->jam_ke }}
                                ({{ \Carbon\Carbon::parse($period->jam_mulai)->format('H:i') }}
                                -
                ...
                <div>
                    ...
                    >
                        ...
                        <option
                            value="1"
                            {{ old('is_active', $teacherSchedule->is_active) == 1 ? 'selected' : '' }}
                        >
                            Aktif
                        </option>
                        ...
                        <option
                            value="0"
                            {{ old('is_active', $teacherSchedule->is_active) == 0 ? 'selected' : '' }}
                        >
                            Tidak Aktif
                        </option>
